 ...
 */
    ...
    function getFotos(){
        global $db;
        global $idFile;
        $strQuery = "SELECT name FROM photo WHERE idProduct = '$idFile' AND name != 'sin_imagen.jpg' ";
    ...
    function deleteFotos(){
        global $db;
        global $idFile;
        $strQuery = "DELETE FROM photo WHERE name = '".$idFile."' ";
    ...
    function insertFotos($foto, $size, $type){
        global $db;
        $strQuery = "INSERT INTO auximgproduct (name, size, type) VALUE ('".$foto."', '".$size."', '".$type."')";
        $strQ = $db->Execute($strQuery);
    }
