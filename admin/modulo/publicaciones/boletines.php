        ...
        <div class="content">
          ...
          <script>
            ...
            if (navbarPosition === 'top') {
          	...
          	<div class="card">
		  		<div class="card-header">
                  	<h5 class="mb-0" data-anchor="data-anchor">Boletines</h5>
                </div>
            <div class="card-body bg-light">
				...
				<div class="card mb-3" id="verForm" style="display:none">					
											...
											<th col-span="3">
												<div class="row mb-3">
													<div class="form-group">
														...
														<button type="button" class="btn btn-danger" onclick="ocultarForm()"><i class="fas fa-trash-alt"></i> Cancelar</button>
													</div>
												</div>	
											</th>
										</tr>
