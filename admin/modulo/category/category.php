...
<head>
  ...
  <body>
			...
			<div class="card mb-3">
				<div class="card-body">
					<div class="row flex-between-center">
						<div class="col-md">
							<h5 class="mb-2 mb-md-0" data-anchor="data-anchor">Categoria</h5>
						</div>
						<div class="col-auto">
		  	...
		  	<div class="card">
				<div class="card-body bg-light">
					<div id="verLista">
						<table id="tblCategory" class="table table-striped table-bordered table-condensed table-hover" cellspacing="0" cellpadding="0" width="100%">
							<thead>
								<tr>
									<th>#</th>
									<th>Categoria</th>
					...
					<div id="verForm">
						<div class="card mb-3">
							<div class="card-body">
								<div class="row flex-between-center">
									<div class="col-md">
										<h5 class="mb-2 mb-md-0">Nueva Categoria</h5>
									</div>

								</div>
							</div>
						</div>
						<form role="form" class="floating-labels m-t-40" name="frmCategory" id="frmCategory" enctype="multipart/form-data" class="needs-validation" novalidate="">
							<div class="row g-0">
								<div class="col-lg-12 left">
									<div class="row">
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
											<div class="form-group has-primary m-b-40">
												<input id="txtIdCategory" type="hidden" maxlength="50" class="form-control" name="txtIdCategory" />
												<label>Nombre Categoria:</label>
												<input id="txtCategory" type="text" maxlength="50" class="form-control" name="txtCategory" required="" autofocus="" />
												<span class="bar"></span>
											</div>
										</div>
	...
	<script type="text/javascript" src="../../assets/js/scripts/category.js"></script>
	<script>
