              ...
              <li class="nav-item">
                <div class="search-box" data-list='{"valueNames":["title"]}'>
                  <form class="position-relative" data-toggle="search" data-display="static">
                      <input class="form-control-search search-input fuzzy-search" type="search" placeholder="Buscar..." aria-label="Search" />
                  ...
                  <div class="dropdown-menu border font-base left-0 mt-2 py-0 overflow-hidden w-100">
                    <div class="scrollbar list py-3" style="max-height: 24rem;">
                      <h6 class="dropdown-header font-weight-medium text-uppercase px-card fs--2 pt-0 pb-2">Recently Browsed</h6><a class="dropdown-item fs--1 px-card py-1 hover-primary" href="events.html">
                      ...
                      <a class="dropdown-item px-card py-1 fs-0" href="events.html">
                      ...
                      <hr class="bg-200" />
                      <h6 class="dropdown-header font-weight-medium text-uppercase px-card fs--2 pt-0 pb-2">Members</h6><a class="dropdown-item px-card py-2" href="profile.html">
                        <div class="d-flex align-items-center">
                      ...
                      <a class="dropdown-item px-card py-2" href="profile.html">
                        <div class="d-flex align-items-center">
