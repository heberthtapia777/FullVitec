			...
			<ul class="navbar-nav flex-column">
				...
				<li class="nav-item">
					...
					<ul class="nav collapse" id="almacen" data-parent="#navbarVerticalCollapse">
						...
						<li class="nav-item"><a class="nav-link" id="category" href="../../modulo/category/category.php">Categorias</a></li>
						<li class="nav-item"><a class="nav-link" id="brand" href="../../modulo/brand/brand.php">Marcas</a></li>						
					</ul>
				</li>
				<li class="nav-item">
					<a class="nav-link dropdown-indicator" href="#galery" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="galery">
						<div class="d-flex align-items-center">
							<span class="nav-link-icon">
								<span class="far fa-images"></span>
							</span>
							<span class="nav-link-text"> Galeria de Fotos</span>
						</div>
					</a>
					<ul class="nav collapse" id="galery" data-parent="#navbarVerticalCollapse">
						<li class="nav-item"><a class="nav-link" id="galery" href="../../modulo/galery/galery.php">Galeria de Fotos</a></li>
					</ul>
				</li>
			</ul>
