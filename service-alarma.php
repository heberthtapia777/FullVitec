...
<div class="container">
	...
	<div class="sigma_post-single-thumb">
		<img src="assets/img/service/details/11.jpg" alt="post">
	...
	<h2>¿Qué es un sistema de alarmas de seguridad?</h2>
	<p>
	Un sistema de alarma consiste en la instalación de una serie de equipos electrónicos en los lugares de su hogar o empresa considerados estratégicos desde el punto de vista de la seguridad. Estos dispositivos pueden ser sensores de movimiento, contactos magnéticos, detectores de humo, botón de pánico, entre otros.
	</p>
	<p>
	El principal objetivo de una alarma es adaptarse a las necesidades y características concretas de la propiedad que se quiere proteger. Para ello, será necesario realizar un estudio de seguridad para determinar el tipo y número de componentes y accesorios de alarma que son necesarios en cada caso.
	</p>
	<p>
	De esta manera, la diferencia entre alarmas para casas y para negocios no reside tanto en el equipo en sí, sino en las necesidades concretas que tienen de manera recurrente viviendas y negocios.
	</p>
